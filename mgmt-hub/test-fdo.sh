...
export FDO_MFG_IMAGE_TAG=${FDO_MFG_IMAGE_TAG:-latest}
#export FDO_SUPPORT_REPO=${FDO_SUPPORT_REPO:-https://raw.githubusercontent.com/open-horizon/SDO-support/master}
FDO_SUPPORT_RELEASE=${FDO_SUPPORT_RELEASE:-https://github.com/open-horizon/FDO-support/releases/latest/download}
FDO_RV_PORT_HTTP=${FDO_RV_PORT_HTTP:-8040}
FDO_RV_PORT_HTTPS=${FDO_RV_PORT_HTTPS:-8041}
