...
export EXCHANGE_LOG_LEVEL=${EXCHANGE_LOG_LEVEL:-DEBUG}
...
export CSS_LOG_LEVEL=${CSS_LOG_LEVEL:-DEBUG}
...
export CSS_TRACE_LEVEL=${CSS_TRACE_LEVEL:-DEBUG}
...
if [[ $HZN_TRANSPORT == 'https' ]]; then
    ...
    export EXCHANGE_TLS_TRUSTSTORE=${EXCHANGE_TLS_TRUSTSTORE:-/etc/horizon/exchange/keys/truststore.p12}
